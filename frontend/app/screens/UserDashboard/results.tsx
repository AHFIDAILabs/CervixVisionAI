    ...
    <Modal visible animationType="slide" onRequestClose={onClose}>
      <View style={modal.container}>
        ...
        <ScrollView contentContainerStyle={modal.body}>
          ...
          {/* Grad-CAM explainability — only generated in connected/server mode */}
          <View style={modal.section}>
            <Text style={modal.sectionTitle}>AI Explainability Heatmap</Text>
            <View style={modal.gradcamNotice}>
              <MaterialIcons name="layers" size={18} color="#6b7280" />
              <Text style={modal.gradcamText}>
                Grad-CAM activation map is generated by the server-side model and is available
                when the device performs a connected analysis. On-device (offline) inference
...
const modal = StyleSheet.create({
  ...
  gradcamText:  { fontSize: 12, color: "#6b7280", lineHeight: 18, flex: 1 },
});
